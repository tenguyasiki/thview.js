...
var ThView = function(arg) {
	...
	this.fadespeed = (arg.fadespeed == undefined) ? 1000 : arg.fadespeed;	// fadeIn /Out speed
	this.interval = (arg.interval == undefined || arg.interval < 1000) ? 1000 : arg.interval;		// animation rate
	this.interval = this.fadespeed*2 + this.interval;
...
ThView.prototype.setLotationSpeed = function(vel){
	this.speed = 0.001 * vel / 10;
}
